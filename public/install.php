...
$link = array(
    'qqun'  => "tencent://message/?uin=2824030364&Site=在线QQ&Menu=yes",
    'forum' => 'https://v2.soubei1123.cn',
);
...
if (isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $mysqlDatabase = isset($_POST['mysqlDatabase']) ? $_POST['mysqlDatabase'] : 'soucms';
    $mysqlPrefix = isset($_POST['mysqlPrefix']) ? $_POST['mysqlPrefix'] : 'sou_';
    ...
    try {
        ...
        $sql = str_replace("`sou_", "`{$mysqlPrefix}", $sql);
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <div class="form-field">
                    ...
                    <input type="text" name="mysqlDatabase" value="soucms" required="">
                </div>
                ...
                <div class="form-field">
                    ...
                    <input type="text" name="mysqlPrefix" value="sou_">
                </div>
            </div>
                    ...
                    $.post('', $(this).serialize())
                        .done(function (ret) {
                            if (ret === 'success') {
                                ...
                                $('<a class="btn" href="<?PHP echo URL_PATH.'index.php';?>">访问首页</a> <a class="btn" href="<?PHP echo URL_PATH.'admin.php';?>" style="background:#18bc9c">访问后台</a>').insertAfter($button);
                                $button.remove();
